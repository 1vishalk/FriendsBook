<?php
	...
	{	
		header("location:facebook homepage/hom.php");
	...
	$sq="select * from fb_register where mobile_no ='$mbno' && email ='$email'";
	...
	{
		$insert="insert into fb_register (first_name, middle_name, last_name, mobile_no, email,password, re_password, dob, gender) values ('$first_name','$middle_name','$last_name','$mbno','$email','$passwd','$r_passwd','$dob','$sex')";
