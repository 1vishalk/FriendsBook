...
<link type="text/css" rel ="stylesheet" href="css files/prof3.css"/>
...
<body>
<div class="header1">
<div id="img3" class ="header1"><img src="profile/llLy.jpg"height="45px" width="90px"/></div>
<div id="searcharea" class ="header1"><input placeholder="search here..." type="text" id="searchbox"/></div>
<div id="profilearea" class ="header1"><img src="profile/profil.png"height="40px" width="40px"/></div>
...
<div id="findf" class ="header1"><img src="profile/frn.png" height="60px" width="50px"/></div>
<div id="message" class ="header1"><img src="profile/chat.png" height="40px" width="35px"/></div>
<div id="notification" class ="header1"><img src="profile/noti.png" height="40px" width="40px"/></div>
<div id="profilearea2" class ="header1">|</div>
<div id="setting" class ="header1"><img src="profile/set.png" height="45px" width="40px" /></div>
<div id="logout" class ="header1"><img src="profile/lo.png" height="40px" width="40px"/></div>
</div>
...
<div class="coverpadx"><img src="profile/cover.jpg" height="400px" width="700px"/>
</div>

<div class="profilepic">
</div>
<div class="profilepic"><img src="profile/kid.jpg" height="140px" width="220px"/>
</div>
...
<div class="post1p"><img src="profile/profil.jpg"/><br><br>
<img src="profile/rogor.jpg" height="411" width="580" /><br><br>
<p6>like comment share</p6><br><br>
<p1>Amit Deb</p1><p2>and</p2><p1>5 other</p1><p2>like this</p2>
<div id="post2text" class="post1p"><p3>Rani Mukharji</p3><p2>with</p2><p1>Arup Pegu</p1><p2>and</p2><p1>15 others.</p1><p4>4 hrs</p4></div>
<div id="commentprof2" class="post1p"><img src="profile/profil.png"/></div>
